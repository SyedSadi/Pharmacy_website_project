...
<body>
    ...
    //     // mysqli_query($conn, "INSERT INTO `record`(transaction_ID,user_id,payment)VALUES
    //     // ('$tid','$user_ID','$grand_total')") or die('query failed');
    // }
    ...
    <div class="shopping-cart">
        ...
        <div class="cart-btn">
            ...
            <a href="cart.php?proceed" class="btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>">proceed to checkout</a>
    ...
    if (isset($_GET["proceed"])) {
        ...
        $tot = $grand_total;
        mysqli_query($conn, "INSERT INTO `record`(transaction_ID,user_id,payment)VALUES
     ('$tid','$user_ID','$tot')") or die('query failed');
    }
